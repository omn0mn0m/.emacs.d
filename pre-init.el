;;; pre-init.el --- This file is loaded before init.el. Use it to set up variables or configurations that need to be available early in the initialization process but after early-init.el. -*- no-byte-compile: t; lexical-binding: t; -*-
