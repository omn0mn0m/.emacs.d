...
(use-package eglot
  ...
  (setq-default eglot-workspace-configuration
                '((:pylsp . (:plugins
                             (;; Fix imports and syntax using `eglot
                              :isort (:enabled t)
...
(use-package org
  ...
  (org-agenda-files '("~/Documents/notebook"))
  :init
...
(use-package ispell
  ...
  :custom
  ;; Set the ispell program name to hunspell
  (ispell-program-name "hunspell")

  ;; Configures Hunspell's suggestion mode to "ultra", which provides more
...
;; Enhancing the Elisp development environment
